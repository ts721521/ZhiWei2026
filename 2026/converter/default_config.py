...
def create_default_config(config_path):
    ...
    try:
        default_config = {
            ...
            "office_com_retry_times": 1,
            "office_retry_delay_seconds": 0.8,
            "office_retry_timeout_scale": 1.5,
            "office_retry_pdf_wait_scale": 1.5,
            "office_retry_timeout_cap_seconds": 600,
            "office_retry_pdf_wait_cap_seconds": 180,
            "timeout_seconds": 60,
            "word_timeout_seconds": 90,
            "excel_timeout_seconds": 90,
            "pdf_wait_seconds": 15,
            "word_pdf_wait_seconds": 20,
            "excel_pdf_wait_seconds": 20,
            "ppt_timeout_seconds": 180,
            "ppt_pdf_wait_seconds": 30,
            "enable_merge": True,
            "output_enable_pdf": True,
            "output_enable_md": True,
            "enable_markdown_image_manifest": True,
